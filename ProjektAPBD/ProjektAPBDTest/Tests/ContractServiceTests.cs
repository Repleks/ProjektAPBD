...
public class ContractServiceTests : IDisposable
{
    ...
    private void InitializeDatabase()
    {
        ...
        var softwareVersion1 = new SoftwareVersion { IdSoftwareVersion = 1, IdSoftware = 1, Version = "1.0"};
        _context.SoftwareVersions.Add(softwareVersion1);
        
        var softwareVersion2 = new SoftwareVersion { IdSoftwareVersion = 2, IdSoftware = 2, Version = "1.0"};
        _context.SoftwareVersions.Add(softwareVersion2);
